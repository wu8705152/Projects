...
combineBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        if (auth.currentUser) {
            ...
            // Using a public collection for now as requested for the dev environment
            await addDoc(collection(db, `artifacts/${__app_id}/public/data/records`), recordData);
            //alert("資料已成功儲存！");
        } else {
